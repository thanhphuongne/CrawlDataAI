...
export const _notifications = [...Array(9)].map((_, index) => ({
  ...
  title:
    ...
    (index === 1 &&
      `<p><strong>Jayvon Hull</strong> mentioned you in <strong><a href='#'>AICrawlData</a></strong></p>`) ||
    (index === 2 &&
...
export const _socials = [
  {
    ...
    color: '#ff001f',
    path: 'https://discord.com/invite/x9BEevYDXN',
  },
  {
    value: 'telegram',
    name: 'Telegram',
  ...
  },
  {
    ...
    icon: 'mdi:youtube',
    color: '#ff001f',
    path: 'https://www.youtube.com/@xOfferNetwork',
  },
  {
    value: 'twitter',
    name: 'Twitter',
    ...
    color: '#00AAEC',
    path: 'https://twitter.com/xOfferNetwork',
  },
  {
    value: 'facebook',
    name: 'Facebook',
    icon: 'mdi:facebook',
    color: '#1877F2',
    path: 'https://www.facebook.com/AICrawlData.io/',
  },
  {
    value: 'tiktok',
    name: 'Tiktok',
